...
{
    protected static readonly uint[] Delta =
    [
        0xC3EFE9DBU,
        0x44626B02U,
        0x79E27C8AU,
    ...
    private uint[] ToUIntArray(byte[] data)
    {
        ...
        result[0] = BinaryPrimitives.ReadUInt32LittleEndian(data.AsSpan(0, 4));
        result[1] = BinaryPrimitives.ReadUInt32LittleEndian(data.AsSpan(4, 4));
        result[2] = BinaryPrimitives.ReadUInt32LittleEndian(data.AsSpan(8, 4));
        result[3] = BinaryPrimitives.ReadUInt32LittleEndian(data.AsSpan(12, 4));
    ...
    private byte[] ToByteArray(uint[] data)
    {
        ...
        BinaryPrimitives.WriteUInt32LittleEndian(result.AsSpan(0, 4), data[0]);
        BinaryPrimitives.WriteUInt32LittleEndian(result.AsSpan(4, 4), data[1]);
        BinaryPrimitives.WriteUInt32LittleEndian(result.AsSpan(8, 4), data[2]);
        BinaryPrimitives.WriteUInt32LittleEndian(result.AsSpan(12, 4), data[3]);
